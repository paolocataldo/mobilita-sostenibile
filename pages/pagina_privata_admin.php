...
// classi
$classi_count = mysqli_fetch_assoc(
    mysqli_query($conn, "
        SELECT COUNT(*) AS totale
        FROM classi
    ")
...
// viaggi
$viaggi_count = mysqli_fetch_assoc(
    mysqli_query($conn, "
        SELECT COUNT(*) AS totale
        FROM viaggi
    ")
...
// co2 totale
$co2_totale = mysqli_fetch_assoc(
    mysqli_query($conn, "
        SELECT SUM(co2) AS totale
        FROM viaggi
    ")
);
...
SELECT
    ...
    u.username
FROM viaggi v
JOIN studenti_viaggi sv
    ON v.id = sv.id_viaggio
JOIN utenti u
            ...
            <?php while($u = mysqli_fetch_assoc($utenti)): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../includes/modifica_utente.php?id=<?= $u['id'] ?>">
                            Modifica
                        </a>
            ...
            <?php while($s = mysqli_fetch_assoc($spostamenti)): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../includes/elimina_spostamento.php?id=<?= $s['id'] ?>"
                           onclick="return confirm('Eliminare spostamento?')">
                            Elimina
                        </a>
