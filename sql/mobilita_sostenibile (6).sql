...
--
-- Host: 127.0.0.1
-- Creato il: Giu 06, 2026 alle 22:02
...
INSERT INTO `scuole_indirizzi` (`id_scuola`, `id_indirizzo`) VALUES
(3, 4),
(3, 5),
(3, 6),
(3, 7);
...
(30, 'paolo2', 'paolocataldo520@gmail.com', 'e7226222d28a9b09aef035be74890a7d', 's', 60, NULL, NULL, NULL);
...
INSERT INTO `viaggi` (`id`, `data`, `distanza_km`, `passeggeri`, `co2`, `id_mezzo`, `riempimento_bus`) VALUES
(1, '2007-10-22', 1, 1, 120, 10, NULL),
(2, '2026-05-30', 4, 2, 80, 16, NULL),
(3, '2026-05-30', 3, 4, 82.5, 11, NULL),
(4, '2026-05-30', 3, 4, 82.5, 11, NULL),
(5, '2026-05-04', 5, 3, 133.333, 12, NULL),
(6, '2026-05-04', 3, 4, 82.5, 11, NULL),
(7, '2026-05-21', 3, 4, 82.5, 11, NULL),
(8, '2026-05-22', 3, 1, 0, 18, NULL),
(9, '2026-06-30', 3, 1, 270, 14, NULL),
(10, '2026-06-04', 3, 4, 82.5, 11, NULL),
(11, '2026-06-02', 10, 1, 400, 16, NULL),
(12, '2026-06-01', 3, 4, 82.5, 11, NULL);
...
ALTER TABLE `studenti_viaggi`
  ...
  ADD CONSTRAINT `studenti_viaggi_ibfk_1` FOREIGN KEY (`id_viaggio`) REFERENCES `viaggi` (`id`);
